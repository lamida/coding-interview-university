...
- [X] [ABC: Always Be Coding](https://medium.com/always-be-coding/abc-always-be-coding-d5f8051afce2#.4heg8zvm4)
    - Always be coding. Do 1 letcode problem a day
    - Pick one programming languages. Master python
    - Know thy complexities: [read cheatsheet](https://www.bigocheatsheet.com/)
    - Reinvent the whell: Implement most common data structure and write test
    - Solve word problem:
